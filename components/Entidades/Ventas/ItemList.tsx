// components/Ventas/ItemsList.tsx
                ...
                return (
                    <View className="p-4">
                        ...
                        <View className="flex-row justify-between">
                            ...
                            <Text className="text-sm font-medium text-green-800">Valor: {item.value || 'N/A'}</Text>
                        </View>

                        <View className="flex-row justify-between mt-1">
                            <Text className="text-sm text-gray-500">Fecha: {item.date || item.createdAt}</Text>
                        </View>
                    </View>
                );
            } else {
                ...
                <Animated.View style={[styles.rightAction, rightActionStyles]}>
                    ...
                    >
                        <View className="items-center justify-center w-12 h-12 rounded-full bg-green-100">
                            <Ionicons name="create" size={24} color="#15803d" />
                        </View>
                    </TouchableOpacity>
                </Animated.View>
