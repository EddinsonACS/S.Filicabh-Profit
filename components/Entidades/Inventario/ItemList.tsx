// components/Inventory/ItemsList.tsx
...
const ItemsList: React.FC<ItemsListProps> = ({
  ...
  const SwipeableItem = ({ item, index }: { item: InventoryItem, index: number }) => {
            ...
            <View className="flex-row">
              ...
              <View className="flex-1">
                ...
                <View className="flex-row justify-between">
                  ...
                  <Text className="text-sm font-medium text-purple-800">Bs. {item.price?.toFixed(2)}</Text>
                </View>
