// components/Inventory/CategorySelector.tsx
    ...
    >
      ...
      >
        {inventoryCategories.map((category) => (
          <TouchableOpacity
            key={category.id}
            className={`mr-3 px-4 py-2 rounded-lg flex-row items-center ${
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                className={`flex-row items-center p-3 border-b border-gray-100 ${
                  selectedCategory === item.type ? 'bg-purple-50' : ''
                }`}
                onPress={() => {
              ...
              >
                <View className={`w-8 h-8 rounded-full ${
                  selectedCategory === item.type ? 'bg-purple-100' : 'bg-gray-100'
